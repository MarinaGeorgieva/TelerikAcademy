	...
	describe('"Task 1: Library"', function() {
		...
		describe('library.books.list', function() {
			...
			it('expect to return array with single book, ' +
				'when category is provided and single book in that category is added',
				function() {
					var book = library.books.add({
						title: CONSTS.VALID.BOOK_TITLE,
						isbn: CONSTS.VALID.BOOK_ISBN.THIRTEEN_DIGITS,
			...
			it('expect to return array with single book, ' +
				...
				'and single book in that category is added',
				function() {
					library.books.add({
			...
			it('expect to return empty array, ' +
				'when category is provided and there is no book with this category',
				function() {
					var book = library.books.add({
						title: CONSTS.VALID.BOOK_TITLE,
						isbn: CONSTS.VALID.BOOK_ISBN.TEN_DIGITS,
			...
			it('expect to return empty array, ' +
				'when author is provided and there is no book of this author',
				function() {
					var book = library.books.add({
						title: CONSTS.VALID.BOOK_TITLE,
						isbn: CONSTS.VALID.BOOK_ISBN.TEN_DIGITS,
